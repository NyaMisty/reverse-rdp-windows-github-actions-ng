 ...
 */
const execShellCommand = (cmd, needOutput = true, detached = false) => {
  core.debug(`Executing shell command: [${cmd}]`)
  return new Promise((resolve, reject) => {
    const proc = (0,external_child_process_namespaceObject.spawn)(cmd, [], { shell: true, detached: detached })
    let stdout = ""
...
const waitForFileDeletion = async (path) => {
